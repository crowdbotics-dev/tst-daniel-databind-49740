...
## Project Structure
    ...
    ├── tst_daniel_databind_49740  # Django project configurations
...
1. Clone this repo and `cd tst_daniel_databind_49740`
...
2. Clone this repo and `cd tst_daniel_databind_49740`
